...
let _offlineBlobUrl = null;  // kept for API compat, no longer used
...
self.addEventListener('install', event => {
  ...
  event.waitUntil(
    (async () => {
      ...
      // FIX #15: убрали URL.createObjectURL — не работает в SW на iOS Safari
...
function _serveOfflinePage() {
  // FIX #15: всегда создаём Response напрямую — blob URL недоступен в SW на iOS Safari
